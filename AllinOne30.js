...
async function getSongInfo(ext) {
  ...
  if (args.hash) musicInfo.hash = `${args.hash}`; if (args.rid) musicInfo.rid = `${args.rid}`; if (args.copyrightId) musicInfo.copyrightId = `${args.copyrightId}`; if (args.album_id) musicInfo.album_id = `${args.album_id}`;
  try {
